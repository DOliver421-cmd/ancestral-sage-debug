...
export default function ScriptScriptorium({ tier = 'base', sovereignDispatch, artifact }) {
  ...
  return (
    <div style={{ fontFamily: 'inherit', color: 'rgba(28,25,23,0.9)', display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
        {DOC_TYPES.map(t => (
          <button
            ...
            style={{
              background: docType === t ? 'rgba(14,116,144,0.15)' : 'rgba(28,25,23,0.03)',
              border: `1px solid ${docType === t ? 'rgba(14,116,144,0.5)' : 'rgba(28,25,23,0.1)'}`,
              color: docType === t ? '#0e7490' : 'rgba(28,25,23,0.5)',
              padding: '6px 14px', fontFamily: 'monospace', fontSize: 11,
              fontWeight: docType === t ? 900 : 400,
              letterSpacing: '0.08em', cursor: 'pointer',
              transition: 'all 0.2s ease',
              boxShadow: docType === t ? '0 0 10px rgba(14,116,144,0.2)' : 'none',
            }}
          >
            {t}
          </button>
      ...
      <div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
          ...
          <div style={{ fontSize: 10, fontFamily: 'monospace', color: 'rgba(28,25,23,0.3)' }}>
            {wordCount} words
          </div>
        </div>
        <textarea
      ...
      <button
        ...
        disabled={loading}
        style={{
          background: loading ? 'rgba(14,116,144,0.15)' : 'linear-gradient(135deg, #155e75, #0e7490)',
          border: 'none', color: loading ? '#0e7490' : '#ffffff',
      ...
      {showDiff && polished && (
        <div>
          <div style={{
            ...
            textTransform: 'uppercase', color: 'rgba(14,116,144,0.7)', marginBottom: 10,
          }}>
            AI Revision — Review Changes
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            <div>
              <div style={{ fontSize: 9, fontFamily: 'monospace', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(28,25,23,0.3)', marginBottom: 6 }}>Original</div>
              <textarea
                readOnly value={content}
                style={{ ...inputStyle, height: 220, fontFamily: 'monospace', fontSize: 12, lineHeight: 1.7, background: 'rgba(28,25,23,0.05)', resize: 'none', color: 'rgba(28,25,23,0.6)' }}
              />
            </div>
            <div>
              <div style={{ fontSize: 9, fontFamily: 'monospace', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(14,116,144,0.6)', marginBottom: 6 }}>AI Polished</div>
              <textarea
                readOnly value={polished}
                style={{ ...inputStyle, height: 220, fontFamily: 'monospace', fontSize: 12, lineHeight: 1.7, color: '#0e7490', background: 'rgba(14,116,144,0.04)', resize: 'none', border: '1px solid rgba(14,116,144,0.3)' }}
              />
            </div>
          </div>
          <div style={{ display: 'flex', gap: 10, marginTop: 10 }}>
            <button
              ...
              style={{
                background: 'rgba(28,25,23,0.06)', border: '1px solid rgba(28,25,23,0.15)',
                color: 'rgba(28,25,23,0.7)', padding: '8px 16px',
            ...
            <button
              ...
              style={{
                background: 'none', border: '1px solid rgba(28,25,23,0.1)',
                color: 'rgba(28,25,23,0.35)', padding: '8px 14px',
...
const labelStyle = {
  ...
  textTransform: 'uppercase', color: 'rgba(146,64,14,0.7)', marginBottom: 6,
};
const inputStyle = {

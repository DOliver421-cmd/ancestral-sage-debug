...
const CUSTOMER_TIERS = [
  ...
  {
    tier: "pro", label: "Pro", price: "$29",
    features: "Video Studio · Professional creator tools",
    items: [
      { to: "/video-studio", label: "Video Studio", icon: Video, testid: "nav-pro-video-studio" },
    ],
  },
  {
    tier: "patron", label: "Patron", price: "$59",
    features: "The Unifier · persona competition judged by Hybrid NAM",
    items: [
      { to: "/unifier", label: "The Unifier", icon: Swords, testid: "nav-unifier" },
    ],
  },
];
...
const STAFF_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/unifier", label: "The Unifier", icon: Swords, testid: "nav-admin-unifier" },
      ...
      { to: "/admin/features", label: "Features & Rollback", icon: Wrench, testid: "nav-features" },
      { to: "/admin/accounts", label: "Account Controls", icon: KeyRound, testid: "nav-account-controls" },
      { to: "/admin/scholarships", label: "Scholarships", icon: HandHelping, testid: "nav-scholarships" },
      { to: "/admin/aawab", label: "AAWAB Admin", icon: HeartPulse, testid: "nav-aawab-admin" },
      { to: "/orchestrator", label: "Orchestrator", icon: Network, testid: "nav-orchestrator" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/exec-control", label: "Sovereign Command", icon: ShieldCheck, testid: "nav-exec-control" },
      { to: "/admin/control", label: "Site Control Panel", icon: Wrench, testid: "nav-site-control" },
      { to: "/admin/director", label: "Director Dashboard", icon: Users, testid: "nav-director" },
      { to: "/admin/staff-meetings", label: "Staff Meetings", icon: ClipboardCheck, testid: "nav-staff-meetings" },
      { to: "/admin/health-report", label: "Site Health Report", icon: ShieldAlert, testid: "nav-health-report" },
      { to: "/admin/features", label: "Features & Rollback", icon: Wrench, testid: "nav-exec-features" },

  ...
  return (
    <div className="min-h-screen bg-bone">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 prose prose-ink max-w-none">
        ...
        <p className="text-xs text-ink/50">[DRAFT — REVIEW: confirm cookie table, consent banner behavior, and any third-party cookies from embedded services.]</p>

        <h2>3a. AI Features and Generated Content</h2>
        <p>Some features use artificial intelligence to generate text and other content. AI output is generated by software and may be inaccurate, incomplete, or unsuitable for your situation — do not rely on it as professional, legal, financial, or medical advice. AI-generated content is identified where practical.</p>
        <p>Conversations you send to AI features may be processed by the AI providers we use to operate those features. Do not share sensitive personal information (such as payment card numbers, health details, or government identifiers) in AI conversations.</p>
        <p className="text-xs text-ink/50">[DRAFT — REVIEW: add — retention period for AI conversation logs, whether conversations are used for model training (they are not), and provider names/links.]</p>

        <h2>3b. Third-Party Providers</h2>
        <p>We use third-party service providers to operate the platform, including payment processors, email delivery, and AI model providers. Payments are processed by our payment providers; we do not store full payment card numbers. When you connect your own AI key (BYOK), your key is encrypted at rest and is used only to route your requests through the provider you chose. Platform staff never see raw keys.</p>
        <p className="text-xs text-ink/50">[DRAFT — REVIEW: add — a named list of subprocessors with links to their privacy policies.]</p>

  ...
  return (
    <div className="min-h-screen bg-bone">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 prose prose-ink max-w-none">
        ...
        <p>Current subprocessors: Stripe (payments), Resend (email), Lemon Squeezy (payments), Gumroad (payments). Each provider's privacy policy is available on their respective websites.</p>

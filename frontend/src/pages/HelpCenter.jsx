...
const CATEGORIES = [
  { icon: Home, title: "Housing", desc: "Help with rent, notices, and shelter resources.", to: "/app/more" },
  { icon: Scale, title: "Legal Help", desc: "Understand letters, bills, and legal papers in plain words.", to: "/more/litigation" },
  { icon: Utensils, title: "Food & Essentials", desc: "Connect to food, clothing, and everyday support.", to: "/app/more" },
  ...
  { icon: HeartPulse, title: "Health & Wellness", desc: "Healing, wellness, and community care.", to: "/app/more" },
];

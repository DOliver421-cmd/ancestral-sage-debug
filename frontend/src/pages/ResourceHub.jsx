 ...
 * Access: Member+ tier, free for staff.
 */
  ...
  if (tier === "free") {
    return (
      <AppShell>
        <div className="max-w-xl mx-auto mt-16 card-flat p-8 text-center">
          <Briefcase className="w-8 h-8 text-copper mx-auto mb-3" />
          <h1 className="font-heading font-bold text-xl text-ink">Member access required</h1>
          <p className="text-sm text-ink/60 mt-2">The Resource Hub requires a Member subscription or higher.</p>
          <Link to="/subscribe" className="btn-primary mt-4 inline-flex">Subscribe to access</Link>
        </div>
      </AppShell>
    );
  }

"""backend/competition_personas.py — System prompts for The Arena competition system.
...
NOTE: This module is intentionally self-contained (stdlib only) so it can live in the
live backend tree without depending on the dead `app/` codebase.
"""

...
_SITE_PAGES = [
    ...
    {"title": "AI Business Office", "link": "/business-office", "group": "pages",
     ...
     "keywords": ["business office", "revenue", "money", "mission", "runway", "funding", "deals", "pipeline", "jobs", "workforce", "social media management", "micro saas", "arbitrage", "brokerage", "audit bureau", "persona foundry", "earn"]},
    {"title": "AI Business Office — Admin", "link": "/admin/business-office", "group": "pages",
     "summary": "Admin desk for the AI Business Office — set the monthly operating goal, manage service deals, and oversee the AI jobs ledger.",
     "keywords": ["business office", "admin", "goal", "deals", "jobs", "oversight", "revenue"]},
]

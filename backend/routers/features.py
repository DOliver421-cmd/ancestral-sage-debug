...
FEATURE_REGISTRY = [
    # ── AI Ecosystem ─────────────────────────────────────────────────────
    {
        ...
        "ecosystem": "NAM",
        "route": "/ai",
        "api_endpoints": ["/api/ai/chat"],
        "default_roles": ["student", "admin", "executive_admin"],
        "default_tiers": ["free", "member", "plus", "pro", "patron"],
        "platform_ai": True,
        "byok_allowed": True,
    ...
    {
        "feature_id": "nam.hybrid",
        "name": "Hybrid NAM",
        "description": "Assistant Director — identity, memory, intentions, dreams, reflections, leadership ledger",
        "category": "ai",
        "ecosystem": "NAM",
        "route": "/nam",
        "api_endpoints": ["/api/nam"],
        "default_roles": ["student", "admin", "executive_admin"],
        "default_tiers": ["free", "member", "plus", "pro", "patron"],
        "platform_ai": True,
        "byok_allowed": True,
        "navigation_group": "NAM",
        "navigation_label": "Hybrid NAM",
        "internal_only": False,
        "customer_access_allowed": True,
        "cost_bearing": True,
    },

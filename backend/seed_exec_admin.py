...
EXEC_EMAIL = os.environ.get("EXEC_SEED_EMAIL", "").strip()
...
if not EXEC_EMAIL:
    raise SystemExit(
        "ERROR: EXEC_SEED_EMAIL must be set in the environment. "
        "Refusing to create an executive account with an unconfigured email."
    )
